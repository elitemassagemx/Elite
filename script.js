...
// ... (continuación de la lista de imágenes)
    ];
...
function setupGalleryAnimations() {
    ...
    console.log('Gallery container found');
    const images = gsap.utils.toArray('.gallery-grid img');
...
function setupFilters() {
    setupFilterButtons('.benefits-nav', '#services-list', '.service-item, .package-item');
}
